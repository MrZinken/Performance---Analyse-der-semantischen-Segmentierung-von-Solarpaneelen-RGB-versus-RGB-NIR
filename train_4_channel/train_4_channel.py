...
# Set the number of times to train the model
n_runs = 10  # Set this to the desired number of times to run the training process

# Training loop to repeat the process n_runs times
for run in range(1, n_runs + 1):
    ...
    run_dir = create_run_directory(run)
    ...
    # Total training time for this run
    total_training_time = time.time() - total_start_time
    print(f"Total training time for run {run}: {total_training_time:.2f} seconds")
