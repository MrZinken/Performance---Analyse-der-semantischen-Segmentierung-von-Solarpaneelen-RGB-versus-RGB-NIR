...
def find_and_copy_and_rename_numpy_arrays(annotation_file, numpy_dir, target_dir):
    ...
    for image_info in annotation_data['images']:
        original_name = os.path.splitext(image_info['file_name'])[0] + '_rgb_ir.npy'  # The original slice name with '_rgb_ir.npy'
        new_name = image_info['file_name']  # The new name exactly as in the annotation file
...
slices_folder = '/media/kai/data/slices'  # Path to the folder containing the NumPy arrays
