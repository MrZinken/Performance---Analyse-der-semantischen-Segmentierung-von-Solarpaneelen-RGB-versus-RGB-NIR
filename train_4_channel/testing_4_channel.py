...
from validation_4_channel import validate, get_validation_loader  # Import validation functions
...
trained_model_path = 'runs/4_channel/2024-10-14_19-10-42/best_multimodal_model_weights_red.pth'  # Replace with your path
...
print("Running validation with timing...")
